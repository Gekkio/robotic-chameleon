...
FROM_3_ARGB(I420ToARGB,     Y, U, V);
FROM_3_ARGB(I422ToARGB,     Y, U, V);
FROM_3_ARGB(I444ToARGB,     Y, U, V);
FROM_3_ARGB(I411ToARGB,     Y, U, V);
FROM_1_ARGB(I400ToARGB,     Y);
FROM_2_ARGB(NV12ToARGB,     Y, UV);
FROM_2_ARGB(NV21ToARGB,     Y, VU);
...
#define JNI_FROM_2_1(NAME) JNI_CONVERT(NAME, JNI_PLANE JNI_PLANE JNI_PLANE)
#define JNI_FROM_3_1       JNI_FROM_1_3
